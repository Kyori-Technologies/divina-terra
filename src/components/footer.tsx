...
export function Footer() {
  return (
    <footer className="mt-16 flex flex-col items-center justify-center gap-6 bg-secondary p-8 text-white">
      <Logo />
      <div className="mt-4 flex flex-col gap-6">
        <ul className="flex items-center justify-center gap-4">
          {links.map((link) => (
            <li
              className="flex items-center justify-center rounded-full border border-white transition-all focus-within:border-primary focus-within:bg-primary hover:border-primary hover:bg-primary"
              key={link.name}
            >
              <a
